...
<th class="text-center"><h3>Ver</h3></th>
  ...
  <tr><td>{{$platillo->nombre}}</td><td class="text-center"><a href="{{ url('/platillos',$platillo->id)}}"><button class="btn btn-primary">Ir</button></a></td>
  </tr>
  @endforeach
</table>
</div>
   ...
   background-color: grey;
    ...
    <script>
      function initMap() {
        ...
        var {{ str_replace(" ","",$puesto->nombre) }} = new google.maps.Marker({
